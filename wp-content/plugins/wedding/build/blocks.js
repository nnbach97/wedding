...
/* harmony import */ var _blocks_Contact__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./blocks/Contact */ "./src/blocks/Contact/index.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("create-block/banner-common", {
  ...
  attributes: {
    ...
    img: {
      type: "object",
      default: {
        url: PV_Admin.PV_BASE_URL + "assets/img/blocks/casestudy/banner_bg_common_story.jpg",
        alt: "",
        id: ""
      }
    }
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("create-block/feature", {
  ...
  attributes: {
    ...
    description: {
      type: "string",
      default: "wedding specializing in providing digital transformation consulting services and software solutions in many domains. We have a highly experienced in house technical team which provides enterprise-level IT consulting design, procurement, and support to customers."
    },
    image: {
      type: "object",
      default: {
  ...
  attributes: {
    ...
    content: {
      ...
      default: [{
        ...
        tooltip: {
          title: "",
          lists: "wedding will go into detail about the experience you want to offer before diving into digital transformation. We will help you in this process by providing answers to the following questions: What, Where, and How?"
        }
      }, {
        ...
        tooltip: {
          title: "",
          lists: "The process of digital transformation is ongoing and has no defined end point. To assure your success, wedding keeps its tech specialists up to date on the newest developments in technology."
        }
      }, {
        ...
        tooltip: {
          title: "",
          lists: "Take a step back as you execute improvements in your company to assess your progress and make any corrections. Then, you can discuss your progress and what isn't working with important stakeholders. In the future, wedding will be available to help you with any additional upgrades."
        }
      }]
    }
  },
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("create-block/visinsight-banner", {
  ...
  attributes: {
    ...
    description: {
      type: "string",
      default: "Is a project management tool of wedding company, aiming to implement the digital transformation roadmap."
    },
    steps: {
      type: "array",
      default: [{
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("create-block/the-fox", {
  ...
  attributes: {
    title: {
      type: "string",
      default: "<strong><span class = 'color'>The Fox</span> - The Mascot Of wedding</strong>"
    },
    image: {
      type: "object",
      default: {
