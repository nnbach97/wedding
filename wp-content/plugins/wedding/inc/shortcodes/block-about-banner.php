  ...
  <div class="block block-about-banner js-hero" style="<?= esc_attr($style_block); ?>">
    <div class="holder">
      <div class="wrapper">
        ...
        <div class="img">
          <img src="<?= P_wedding_RESOURCE_HOST . '/assets/img/blocks/about-banner/about-img01.png' ?>" alt="">
        </div>
      </div>
    </div>
  </div>
