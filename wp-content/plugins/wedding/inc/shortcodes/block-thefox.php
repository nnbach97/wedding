...
$registerBlock[] = [
  ...
  'callback' => 'wedding_shortcode_block_thefox'
];

function wedding_shortcode_block_thefox($atts, $content)
{
  $title = wedding_func_check_data('title', $atts, "<strong><span class = 'color'>The Fox</span> - The Mascot Of wedding</strong>");
  ...
  $image_url = wedding_func_check_data('url', $image, P_wedding_RESOURCE_HOST . 'assets/img/blocks/thefox/the-fox.png');
