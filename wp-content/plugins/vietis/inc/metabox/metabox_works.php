...
class metabox_url_release_works {
  ...
  public function meta_boxes() {
    add_meta_box('metabox_url_release_works', __('Link release', 'wedding'), [$this, 'output'], [wedding_POST_TYPE_WORKS], 'side', 'default');
  }
      ...
      <div class="components-panel__body components-panel__body--url">
        <div class="components-base-control">
          <div class="components-base-control__field">
            <input type="text" name="link_release" class="components-text-control__input" placeholder="<?= __('Link release', 'wedding'); ?>" value="<?= esc_attr($link_release); ?>">
          </div>
        </div>
      </div>
    <?php
