...
if (!class_exists('vietis_tax_meta_image')) {
    class vietis_tax_meta_image {
        ...
        public function add_category_image ($taxonomy) { ?>
            <div class="wrapper-images-list single">
                <label><?php _e( 'Hình ảnh', 'vietis' ); ?></label>
                ...
                <input type="button" class="button button-secondary js-category-botton-add" value="<?php _e( 'Add Image', 'vietis' ); ?>" />
                <input type="button" class="button button-secondary js-category-botton-remove" style="display: none;" value="<?php _e( 'Remove Image', 'vietis' ); ?>" />
            </div>
        <?php }

        public function update_category_image ( $term, $taxonomy ) { ?>
            <tr class="form-field term-group-wrap">
                <th scope="row"><label><?php _e( 'Hình ảnh', 'vietis' ); ?></label></th>
                <td>
                    ...
                    <div class="wrapper-images-list single">
                        ...
                        <input type="button" class="button button-secondary js-category-botton-add" value="<?php _e( 'Add Image', 'vietis' ); ?>" />
                        <input type="button" class="button button-secondary js-category-botton-remove" style="<?= $image_id ? '' : 'display: none;'; ?>" value="<?php _e( 'Remove Image', 'vietis' ); ?>" />
                    </div>
                </td>
            </tr>
        <?php }
        ...
        public function save_category_image ( $term_id, $tt_id ) {
            $id = vietis_func_check_data('category-image-id', $_POST);
