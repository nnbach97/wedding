...
class vietis_plugin_assets
{
  ...
  public function get_param()
  {
    $params = [
      ...
      'PV_BASE_URL' => P_VIETIS_RESOURCE_HOST,
      'HOST' => get_site_url(),
      'SECURITY' => wp_create_nonce('VIETIS_SECURITY'),
  ...
  {
    wp_register_style('bootstrap', P_VIETIS_RESOURCE_HOST . 'assets/libs/bootstrap/bootstrap.min.css', [], '1.0');
    wp_enqueue_style('bootstrap');

    wp_register_style('block', P_VIETIS_RESOURCE_HOST . 'assets/css/block.css', [], '1.2');
    wp_enqueue_style('block');

    wp_register_style('style', P_VIETIS_RESOURCE_HOST . 'assets/css/admin/style.css', [], '1.2');
    wp_enqueue_style('style');

    wp_register_script('bootstrap', P_VIETIS_RESOURCE_HOST . 'assets/libs/bootstrap/bootstrap.min.js', ['jquery'], '1.0');
    wp_enqueue_script('bootstrap');

    wp_enqueue_media();

    wp_register_script('main-admin', P_VIETIS_RESOURCE_HOST . 'assets/js/admin/main.js', ['jquery'], '1.2');
    wp_enqueue_script('main-admin');

    wp_localize_script('create-block-vietis-editor-script', 'PV_Admin', $this->get_param());
  }
  ...
  public function load_script()
  {
    ...
    wp_register_script('main', P_VIETIS_RESOURCE_HOST . 'assets/js/main.js', ['jquery'], '1.1');
    wp_enqueue_script('main');

    wp_register_script('wow', P_VIETIS_RESOURCE_HOST . 'assets/js/wow.min.js', ['jquery'], '1.1');
    wp_enqueue_script('wow');

    wp_register_script('home', P_VIETIS_RESOURCE_HOST . 'assets/js/block.js', ['jquery'], '1.9');
