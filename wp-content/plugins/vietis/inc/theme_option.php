        ...
        <form method="post" action="options.php">
          ...
          <div class="company-information">
            <div class="company-information__item">
              <h3 class="company-information"><?= __('VietIS Corporation', 'vietis'); ?></h3>
              <table class="form-table wpex-custom-admin-login-table">
                <tr valign="top">
                  <th scope="row"><?= __('Tên công ty:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Năm thành lập:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Người đại diện:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Địa chỉ:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Số điện thoại:', 'vietis'); ?></th>
                  <td>
            ...
            <div class="company-information__item">
              <h2 class="company-information"><?= __('VietIS Solution', 'vietis'); ?></h2>
              <table class="form-table wpex-custom-admin-login-table">
                <tr valign="top">
                  <th scope="row"><?= __('Tên công ty:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Địa chỉ 1:', 'vietis'); ?></th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row"><?= __('Địa chỉ 2:', 'vietis'); ?></th>
                  <td>
            ...
            <div class="company-information__item">
              <h2 class="company-information"><?= __('Us office', 'vietis'); ?></h2>
              <table class="form-table wpex-custom-admin-login-table">
                <tr valign="top">
                  <th scope="row"><?= __('Tên công ty:', 'vietis'); ?></th>
                  <td>
            ...
            <div class="company-information__item">
              <h2 class="company-information"><?= __('Viet FinTech', 'vietis'); ?></h2>
              <table class="form-table wpex-custom-admin-login-table">
                <tr valign="top">
                  <th scope="row"><?= __('Tên công ty:', 'vietis'); ?></th>
                  <td>
          ...
          <table class="form-table wpex-custom-admin-login-table">
            <tr valign="top">
              <th scope="row"><?= __('Email liên hệ:', 'vietis'); ?></th>
              <td>
            ...
            <tr valign="top">
              <th scope="row"><?= __('Link facebook:', 'vietis'); ?></th>
              <td>
            ...
            <tr valign="top">
              <th scope="row"><?= __('Link youtube:', 'vietis'); ?></th>
              <td>
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <p class="description">
                  <?= __('US Office Mỗi mail nhận cách nhau bởi dấu phẩy "," hoặc mỗi mail nhận trên 1 dòng.', 'vietis'); ?><br>
                  <em><strong><?= __('Ví dụ 1:', 'vietis'); ?> </strong> <?= __('contact.001@gmail.com, contact.002@gmail.com', 'vietis'); ?></em><br>
                  <em><strong><?= __('Ví dụ 2:', 'vietis'); ?> </strong><br><?= __('contact.001@gmail.com', 'vietis'); ?><br><?= __('contact.002@gmail.com', 'vietis'); ?></em>
                </p>
              </td>
            </tr>
          </table>
