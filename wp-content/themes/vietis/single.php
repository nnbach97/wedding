...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  ...
  <div class="block common-block-banner js-hero">
    ...
    <div class="banner-inner">
      ...
      <div class="des"><?= get_the_date(); ?> / <?= vietis_get_post_primary_category(); ?></div>
    </div>
  </div>
  <!-- END: Banner -->
  <!-- Blogs -->
      ...
      <div class="blogs-inner">
        <div class="content">
          ...
          <div class="new-nav">
            ...
            ?>
            <a class="btn-prev <?= $disablePrev ? 'disabled' : ''; ?>" href="<?= get_the_permalink(get_next_post()) ?>"><?= __("Previous post", "vietis") ?></a>
            <a class="btn-next <?= $disableNext ? 'disabled' : ''; ?>" href="<?= get_the_permalink(get_previous_post()) ?>"><?= __("Next post", "vietis") ?></a>
          </div>
        </div>
